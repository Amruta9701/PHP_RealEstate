                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Discover a wide range of properties, from cozy apartments to luxurious homes, all meticulously listed with detailed descriptions, high-quality images, and virtual tours. Our extensive database is updated regularly to ensure you have access to the latest listings.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Whether you're buying, selling, or renting, we provide insightful guidance to help you make informed decisions.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We understand that every client has unique needs and preferences. Our dedicated agents offer personalized consultations to tailor our services to your specific requirements, ensuring a smooth and satisfying real estate experience.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We are proud to be active members of the community we serve. Our involvement in local events and charitable initiatives reflects our commitment to giving back and enhancing the neighborhoods we operate in.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We prioritize your convenience and security. Our seamless transaction process, from initial consultation to closing, ensures a hassle-free experience. We handle all the paperwork and negotiations, so you can focus on what matters most.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
                                ...
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Stay informed with our comprehensive market insights and trends. Our blog and resource center offer valuable articles, tips, and updates on the latest market conditions, helping you stay ahead in the real estate game.</p>
									</div>
                                </li>
                            </ul>
                        </div>
...
Our "Discussion" feature facilitates seamless communication between buyers, sellers, and agents. This tool ensures that all parties involved in a real estate transaction can easily exchange messages, share updates, and clarify doubts in real-time.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Efficient Document Management
The "File" feature in our system provides a centralized location for managing all your real estate documents. This tool ensures that all necessary paperwork is organized, accessible, and secure, simplifying the transaction process.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Streamlined Acquisition Process
Our "Acquire" feature guides you through the entire property acquisition process, from initial search to final purchase. This tool is designed to simplify and streamline each step, making it easier for you to acquire your desired property.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										 $query=mysqli_query($con,"SELECT state, COUNT(*) as property_count 
                                         FROM property 
                                         WHERE city='pune'
                                         GROUP BY state");
											while($row=mysqli_fetch_array($query))
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM realestatephp.property where city='indore'GROUP BY property.pid");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM realestatephp.property where city='panji'GROUP BY property.pid");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM realestatephp.property where city='jaipur'GROUP BY property.pid");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
